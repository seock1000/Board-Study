...
public class ArticleClient {
    ...
    @Value("${endpoints.seock1000-board-article-service.url}")
    ...
    public ArticlePageResponse readAll(Long boardId, Long page, Long pageSize) {
        try {
            ...
            log.error("[ArticleClient.readAll] boardId={}, page={}, size={}", boardId, page, pageSize, e);
    ...
    public List<ArticleResponse> readAllInfiniteScroll(Long boardId, Long lastArticleId, Long pageSize) {
        try {
            ...
            log.error("[ArticleClient.readAllInfiniteScroll] boardId={}, lastArticleId={}, size={}", boardId, lastArticleId, pageSize, e);
            return List.of();
        }
    }
    ...
    public long count(Long boardId) {
        try {
            return restClient.get()
                    .uri("/v1/articles/board/{boardId}/count", boardId)
                    .retrieve()
                    .body(Long.class);
        } catch (Exception e) {
